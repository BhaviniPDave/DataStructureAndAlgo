 ...
 * However, choosing the rightmost card first will maximize your total score. The optimal strategy is to take the
 ...
 * Output: 202
 */
public class MaxPointsToObtainFromCardsG {
    ...
    public static void main (String[] args) {
        MaxPointsToObtainFromCardsG obj = new MaxPointsToObtainFromCardsG();
